...
* [bugs and features](https://bugs.galette.eu/projects/galette-plugin-objectslend)
* [source code](https://github.com/galette-plugins/plugin-objectslend)
* mailing lists:
...
* or using the [source code from the repository](https://github.com/galette-plugins/plugin-objectslend),
